/* Programa: ComparacionCadenas.cpp
Objetivo: Demostrar la correcta evaluacion del contenido de cadenas usando strcmp.
*/
#include <iostream> // Operaciones estándar de consola
#include <cstring> // Contiene la declaracion oficial de strcmp()
using namespace std;
int main() {
